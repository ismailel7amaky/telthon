...
async def bot_start(event):
    ...
    if chat.id != Config.OWNER_ID:
        ...
        buttons = [
            (
                Button.url("السورس", "https://t.me/C_U_U_1"),
                Button.url(
                    "المطور",
                    "https://t.me/U_U_Q_1",
                ),
        ...
        buttons = [
            ...
            [
                ...
                Button.inline("• المطور •", data="https://t.me/U_U_Q_1"),
            ],
        ]
    try:
        if custompic:
...
اوامر فارات سورس السلطان  @C_U_U_1""",
        buttons=[
...
* يمكنك الحصول على  كليشة جاهزة من هذه القناة @C_U_U_3 
